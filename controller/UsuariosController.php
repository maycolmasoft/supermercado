	...
	public function InsertaUsuarios(){
		...
		if (isset(  $_SESSION['nombre_usuarios']) )
		{
    		...
    		if (isset ($_POST["cedula_usuarios"]))
    		{
    		    ...
    		    {
    		        $directorio = $_SERVER['DOCUMENT_ROOT'].'/supermercado/fotografias_usuarios/';
	...
	public function resetear_clave_inicio()
	{
		...
		if (isset($_POST['cedula_usuarios']))
		{
			...
			else
			{
				...
				$asunto="Claves de Acceso supermercados";
				$fecha=date("d/m/y");
				$hora=date("H:i:s");
				...
				$resumen="
				<table rules='all'>
				<tr><td WIDTH='1000' HEIGHT='50'><center><img src='http://3.239.81.129:80/erp_riesgos/view/images/fondo_login.png' WIDTH='300' HEIGHT='120'/></center></td></tr>
				</tabla>
				...
				<p><table rules='all'></p>
				<tr style='background:#1C1C1C'><td WIDTH='1000' HEIGHT='50' align='center'><font color='white'>supermercados - <a href='http://www.google.com.ec'><FONT COLOR='#7acb5a'>www.supermercados.com.ec</FONT></a> - Copyright © 2022-</font></td></tr>
				</table>
				";
	
	
				if(mail("$destino","Claves de Acceso supermercados","$resumen","$cabeceras"))
				{
