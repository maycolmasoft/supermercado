...
$image = "";
$conn =  pg_connect("host=18.218.52.218 port=5432 dbname=sflores user=postgres password=Fcpc.2021");
...
else 
{
		...
		if (!empty($res))
		{
				...
				{
					$archivo=$_SERVER['DOCUMENT_ROOT'].'/supermercado/view/images/'.'nodisponible.jpg';
