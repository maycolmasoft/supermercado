 ...
 <?php  $dias = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sábado");
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form id="frm_act_usuario" action="<?php echo $helper->url("Usuarios","InsertaUsuarios"); ?>" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-xs-12">
                      ...
                      <?php } } ?>                     
                     	...
                     	<div class="row">
            			    <div class="col-xs-12 col-md-12 col-md-12 " style="margin-top:15px;  text-align: center; ">
            	                  ...
            	                  <a class="btn btn-danger" href="<?php  echo $helper->url("Usuarios","Bienvenida"); ?>">CANCELAR</a>
        	                    </div>
    	        		    </div>
   ...
   <script src="view/bootstrap/plugins/input-mask/jquery.inputmask.js"></script>
    ...
    <script src="view/Administracion/js/Usuarios.js?4.4"></script>         	
  </body>
</html>
